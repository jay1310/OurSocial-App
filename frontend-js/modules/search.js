...
export default class Search {
    constructor() {
        // 1. Selecting DOM elem and keep track of any useful data
...
renderResultsHTML(posts) {
  if(posts.length){
    ...
    this.resultsArea.innerHTML = `<p class = "alert alert-danger text-center shadow-sm">Sorry, No result found for the searched data </p>`
  }
  this.hideLoaderIcon()
